...
notP :: Int -> ST Bool -> ST Bool
notP _ = applyST $ \x -> case x of False -> Val True
                                   True  -> Val False
...
notS x = fromST_Bool_Bool (notP 1 (toST_Bool_Bool x))
