...
-- Plural function:
ndconstP :: IDSupply -> ST Int -> ST Int -> ST Int
ndconstP s nx _ = (\x -> Choice (uniqueID s) (Val x) (Val 1)) `applyST` nx

-- Set function:
ndconstS :: Int -> Int -> Values Int
ndconstS x y =
  fromST_Int_Int (ndconstP initSupply (toST_Int_Int x) (toST_Int_Int y))
