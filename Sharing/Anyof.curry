...
anyOfP s = applyST $ \xs -> case xs of
  Nil       -> Fail
  Cons y ys -> Choice (uniqueID s) y (anyOfP (leftSupply s) ys)

-- The set function:
anyOfS :: [Int] -> Values Int
anyOfS x = fromST_Int_Int (anyOfP initSupply (toST_List_STList toST_Int_Int x))
